...
Player.prototype.warpDown = function () {
  this._warp([190, 160], [190, 192], [190, 160], [140, 225], "DOWN");
};
...
Player.prototype._warp = function (img1, img2, img3, img4, direction) {
  this.warping = true;
  this.warpReady = false;
  var self = this;
  frame1 = setInterval(function () {
    self.ctx.drawImage(self.image, img1[0], img1[1], 27, 35, self.x - 22, self.y -30, 35, 50);
    // console.log("hello?");
  },1000/50)
  setTimeout(function(){
    clearInterval(frame1);
    frame2 = setInterval(function () {
      self.ctx.drawImage(self.image, img2[0], img2[1], 27, 34, self.x - 22, self.y - 30, 35, 50);
    }, 1000 / 50)
  }, 100)
  ...
  setTimeout (function () {
    ...
    frame3 = setInterval(function () {
      self.ctx.drawImage(self.image, img3[0], img3[1], 27, 35, self.x - 22, self.y -30, 35, 50);
    }, 1000/50)
  }, 500)
  ...
  setTimeout (function () {
    ...
    frame4 = setInterval(function () {
      self.ctx.drawImage(self.image, img4[0], img4[1], 27, 34, self.x - 22, self.y - 30, 35, 50);
    }, 1000/50)
  }, 610)
