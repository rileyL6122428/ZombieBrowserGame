...
function LevelOne(ctx) {
  this.ctx = ctx;
  this.player = new Player(100, 600, ctx);
  ...
  this.normalZombies = [
    ...
    new NormalZombie(310, 400, this.player, 0),
    new NormalZombie(440, 520, this.player, 0),
    new NormalZombie(40, 40, this.player, 0),
    new NormalZombie(50, 50, this.player, 0)
  ];
  this.registerHerd();
